...
public class modal_Toast_Custom extends AppCompatActivity{
    ...
    //Todos los mètodos getLayoutInflater() dan error estando en una clase separa de una actividad completa.
    //Verificare eso luego para ver que proboca.

    public void dialogAcercadeCustom(final Context context) {
        final android.app.AlertDialog.Builder mBuilder = new android.app.AlertDialog.Builder(context);
        mBuilder.setIcon(R.drawable.ic_info);
        mBuilder.setTitle("Acerca de");
        mBuilder.setCancelable(false);

        final View mView = getLayoutInflater().inflate(R.layout.dialog_autor, null);

        Toast toast = Toast.makeText(context, "Programador/Diseñador de App", Toast.LENGTH_LONG);
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.show();
    ...
    public void about_autor(final Context context) {
        final android.app.AlertDialog.Builder mBuilder = new android.app.AlertDialog.Builder(context);
        //AlertDialog.Builder mBuilder = new AlertDialog.Builder(getApplicationContext());
        //mBuilder.setIcon(R.drawable.ic_servidor);
        //mBuilder.setTitle("<<<ITCA>>>");
        mBuilder.setCancelable(true);
        final View mView = getLayoutInflater().inflate(R.layout.dialog_autor, null);

        //Unico elemento del modal que se programara accion.
   ...
   /*
    public void showToast1(final Context context, String message) {
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_layout, (ViewGroup) findViewById(R.id.toast_root));
