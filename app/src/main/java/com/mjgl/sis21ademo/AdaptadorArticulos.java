...
public class AdaptadorArticulos extends RecyclerView.Adapter<AdaptadorArticulos.ArticulosViewHolder>{
    ...
    */
    ...
    En nuestro ejemplo, aquí es donde se tiene que establecer los valores de los campos de codigo, descripcion y precio del CardView.
     */
    @Override
    ...
    */
    ...
    //en la vista (Layout o xml) Personalizado. Este es el diseño personalizado para pintar cada registro en el recyclerview.
